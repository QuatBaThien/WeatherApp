...
public final class FragmentTitleBinding implements ViewBinding {
  ...
  @NonNull
  public final ConstraintLayout layoutTittle;
  ...
  private FragmentTitleBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout layoutTittle, @NonNull TextView tvCity, @NonNull TextView tvDate) {
    this.rootView = rootView;
    this.layoutTittle = layoutTittle;
    this.tvCity = tvCity;
    this.tvDate = tvDate;
  }
  ...
  public static FragmentTitleBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      ConstraintLayout layoutTittle = (ConstraintLayout) rootView;
      ...
      return new FragmentTitleBinding((ConstraintLayout) rootView, layoutTittle, tvCity, tvDate);
    }
